...
''')
medcite_post_system = '''You are a helpful medical expert and your task is to try to find documents that supports the statement, given relevant documents.'''
medcite_post_prompt = Template('''
Here are the relevant documents:
{{context}}
...
Output only the document IDs with which supports the statement. Do not output other things.
''')